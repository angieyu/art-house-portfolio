...
var App = function App(props) {
  ...
  //   return (
  //   <div>
  //     <Profile authenticate={this.authenticate} handleUser={this.handleUser} handlePass={this.handlePass} handleSample={this.handleSample} handleSubmitSignup={this.handleSubmitSignup} handleSubmitLogin={this.handleSubmitLogin} />
  //   </div>
  // )
};
