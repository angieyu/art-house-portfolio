  ...
  _createClass(Container, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_Signup2.default, { authenticate: this.authenticate, handleUser: this.handleUser, handlePass: this.handlePass, handleSample: this.handleSample, handleSubmitSignup: this.handleSubmitSignup, handleSubmitLogin: this.handleSubmitLogin }),
        _react2.default.createElement(_Login2.default, { authenticate: this.authenticate, handleUser: this.handleUser, handlePass: this.handlePass, handleSample: this.handleSample, handleSubmitSignup: this.handleSubmitSignup, handleSubmitLogin: this.handleSubmitLogin }),
